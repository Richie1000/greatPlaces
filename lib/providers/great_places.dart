...
class GreatPlaces with ChangeNotifier {
  ...
  Future <void> addPlace(
    ...
    DBHelper.insert('user_places', {
      ...
      'latdata': newPlace.location.latitude,
      'lngdata': newPlace.location.longitude,
    ...
    _items = dataList
        .map(
          (item) => Place(
                ...
                location: PlaceLocation(latitude: item['latdata'], longitude: item['lngdata'], address: item['address']),
              ),
        )
        .toList();
    notifyListeners();
